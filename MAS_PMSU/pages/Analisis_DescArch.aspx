<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="Analisis_DescArch.aspx.vb" Inherits="MAS_PMSU.Analisis_DescArch" %>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="GridDatos" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:ButtonField ButtonType="Button" Text="Descargar" ControlStyle-CssClass="btn btn-success" HeaderText="Analisis Firmada" CommandName="FichaLote">
