...
Public Class InventarioReport6
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MAS_PMSU.InventarioReport6.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInventarioReport6
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InventarioReport6 = New InventarioReport6()
        rpt.Site = Me.Site
        Return rpt
    End Function
