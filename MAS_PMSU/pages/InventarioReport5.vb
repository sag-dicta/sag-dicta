...
Public Class InventarioReport5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MAS_PMSU.InventarioReport5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInventarioReport5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InventarioReport5 = New InventarioReport5()
        rpt.Site = Me.Site
        Return rpt
    End Function
