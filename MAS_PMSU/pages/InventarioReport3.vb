...
Public Class InventarioReport3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MAS_PMSU.InventarioReport3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInventarioReport3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InventarioReport3 = New InventarioReport3()
        rpt.Site = Me.Site
        Return rpt
    End Function
