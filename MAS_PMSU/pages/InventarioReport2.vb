...
Public Class InventarioReport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MAS_PMSU.InventarioReport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInventarioReport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InventarioReport2 = New InventarioReport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
