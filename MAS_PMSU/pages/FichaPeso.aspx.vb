...
Public Class FichaPeso
    ...
    Sub llenagrid()
        ...
        Me.SqlDataSource1.SelectCommand = "SELECT " & cadena & " FROM `vista_acta_lote_multi` WHERE 1 = 1 AND semilla_QQ_oro IS NOT NULL AND DECISION='APROBADO' AND estado_sena = '1' " & c1 & c3 & c4 & c2 & "ORDER BY id_acta DESC"
