...
Public Class Cuando_Procesamiento_DescArch
    ...
    Protected Sub GridDatos_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridDatos.RowCommand
        ...
        If (e.CommandName = "FichaLote") Then
            ...
            Dim Str As String = "SELECT cuadro_firmado FROM `vista_acta_lote_multi` WHERE  ID_acta='" & HttpUtility.HtmlDecode(gvrow.Cells(0).Text).ToString & "' "
                    ...
                    Using connection As New MySqlConnection(conn)
                        ...
                        Using command As New MySqlCommand(Str, connection)
                            Using reader As MySqlDataReader = command.ExecuteReader()
                                If reader.Read() Then
                                    Dim pdfData As Byte() = DirectCast(reader("cuadro_firmado"), Byte())
                                    ...
                                    HttpContext.Current.Response.AppendHeader("Content-Disposition", "attachment; filename=Cuadro de procesamiento_" & nombre & "_" & lote & "_Firmado.pdf") ' Cambia el nombre del archivo con la extensión PDF
