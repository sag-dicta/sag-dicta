...
Public Class InventarioReport7
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MAS_PMSU.InventarioReport7.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInventarioReport7
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InventarioReport7 = New InventarioReport7()
        rpt.Site = Me.Site
        Return rpt
    End Function
