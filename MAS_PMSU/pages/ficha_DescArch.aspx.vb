...
Public Class ficha_DescArch
    ...
    Protected Sub GridDatos_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridDatos.RowCommand
        ...
        If (e.CommandName = "FichaLote") Then
            ...
            Dim Str As String = "SELECT ficha_firmado FROM `vista_acta_lote_multi` WHERE  ID_acta='" & HttpUtility.HtmlDecode(gvrow.Cells(0).Text).ToString & "' "
                    ...
                    Using connection As New MySqlConnection(conn)
                        ...
                        Using command As New MySqlCommand(Str, connection)
                            Using reader As MySqlDataReader = command.ExecuteReader()
                                If reader.Read() Then
                                    Dim pdfData As Byte() = DirectCast(reader("ficha_firmado"), Byte())
                                    ...
                                    HttpContext.Current.Response.AppendHeader("Content-Disposition", "attachment; filename=Ficha De Peso Al Recibo Lotes De Semilla _" & nombre & "_" & lote & "_Firmado.pdf") ' Cambia el nombre del archivo con la extensión PDF
    ...
    Protected Sub GridDatos_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs) Handles GridDatos.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim imagenFicha As String = DataBinder.Eval(e.Row.DataItem, "ficha_firmado").ToString()
