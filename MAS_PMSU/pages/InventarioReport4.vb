...
Public Class InventarioReport4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MAS_PMSU.InventarioReport4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInventarioReport4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InventarioReport4 = New InventarioReport4()
        rpt.Site = Me.Site
        Return rpt
    End Function
