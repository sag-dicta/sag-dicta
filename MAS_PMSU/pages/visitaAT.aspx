<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="visitaAT.aspx.vb" Inherits="MAS_PMSU.visitaAT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Registro de campo</h1>
        </div>
    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="table-responsive">
                                    <h4>
                                        <span style="float: right;"><small># Registros:</small>
                                            <asp:Label ID="lblTotalClientes" runat="server" CssClass="label label-warning" /></span>
                                    </h4>
                                    <p>&nbsp;</p>
                                    <p>&nbsp;</p>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:connSAGV2 %>" ProviderName="<%$ ConnectionStrings:connSAGV2.ProviderName %>"></asp:SqlDataSource>
                                    <asp:GridView ID="GridDatos" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                        ...
                                        <EmptyDataTemplate>
                                            ¡No hay registros de campo disponibles!
                                        </EmptyDataTemplate>
                                        <%--Paginador...--%>
                                        ...
                                        <Columns>
                                         ...
                                         <asp:BoundField DataField="Nombre del resposable" HeaderText="Nombre del resposable" />
                                     
                                             <asp:BoundField DataField="9. No Lote" HeaderText="No Lote" />
                                                  <asp:BoundField DataField="5. Seleccionar cultivo" HeaderText="Cultivo" />
                                             <asp:BoundField DataField="6. Seleccionar variedad" HeaderText="Variedad" />
                                          <%--  
                                            <asp:ButtonField ButtonType="Button" Text="Generar PDF" ControlStyle-CssClass="btn btn-warning" HeaderText="Reporte" CommandName="Imprimir">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-warning" Text="Exportar Datos"><span class="glyphicon glyphicon-qrcode"></span>&nbsp;Exportar</asp:LinkButton>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox CssClass="form-control" ID="TxtIdentidad" runat="server" AutoPostBack="true" MaxLength="13" OnTextChanged="VerificarTextBox" onkeypress="return numericOnly(this);"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox CssClass="form-control" ID="TxtTelefono" runat="server" AutoPostBack="true" MaxLength="8" OnTextChanged="VerificarTextBox" onkeypress="return numericOnly(this);"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
