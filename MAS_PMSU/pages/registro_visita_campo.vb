...
Public Class registro_visita_campo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "registro_visita_campo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MAS_PMSU.registro_visita_campo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedregistro_visita_campo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As registro_visita_campo = New registro_visita_campo()
        rpt.Site = Me.Site
        Return rpt
    End Function
