<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="generar_qrs.aspx.vb" Inherits="MAS_PMSU.generar_qrs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Generación de código QRS de Multiplicador o Estación</h1>
        </div>
    </div>
                    ...
                    <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="GridDatos" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:ButtonField ButtonType="Button" Text="Generar QRS" ControlStyle-CssClass="btn btn-warning" HeaderText="QRS" CommandName="Imprimir">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-warning" Text="Exportar Datos"><span class="glyphicon glyphicon-qrcode"></span>&nbsp;Generar todos los QRS</asp:LinkButton>
                            </div>
                        </div>
